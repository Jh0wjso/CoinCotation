...
export default function CoinValue({ route }){
    ...
    async function coinInfos(){
        ...
        const coinResponse = await fetch(`https://www.mercadobitcoin.net/api/${route.params.domainName}/ticker/`);
    ...
    return(
        <View style={styles.principal}>
            <Text style={styles.textoInicial}>PRINCIPAIS INFORMAÇÕES</Text>
